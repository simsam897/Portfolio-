...
const Hero = () => {
  return (
    // <section className="mx-auto max-w-6xl px-4 py-12  gap-10 animate-slide-from-left flex flex-col justify-center items-center">
    <section className="mx-auto max-w-6xl px-4 py-12 md-hero:flex md-hero:flex-row md-hero:justify-between md-hero:items-center gap-10 animate-slide-from-left flex flex-col justify-center items-center">
      {/* text-section */}
